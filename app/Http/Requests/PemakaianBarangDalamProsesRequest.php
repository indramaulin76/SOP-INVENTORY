...
class PemakaianBarangDalamProsesRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'nomor_bukti' => 'required|string|max:255|unique:pemakaian_barang_dalam_proses,nomor_bukti',
    ...
    public function messages()
    {
        return [
            ...
            'barang_nama.*.exists' => 'Nama barang dalam proses tidak terdaftar dalam master barang.',
            'barang_kode.required' => 'Minimal satu barang harus diinput.',
            'barang_kode.*.required' => 'Kode barang wajib diisi.',
            'barang_kode.*.exists' => 'Kode barang dalam proses tidak sesuai master barang.',
