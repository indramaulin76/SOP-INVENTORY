        ...
        try {
            ...
            if (data.success && data.barang) {
                ...
                if (!allowedKategori.includes(kategori)) {
                    alert('Barang "' + namaBarang + '" bukan kategori Barang Dalam Proses. Hanya barang dengan kategori "Barang Dalam Proses" yang dapat digunakan untuk input barang dalam proses.');
                    namaInput.value = '';
                    if (kodeInput) kodeInput.value = '';
                    if (hargaInput) hargaInput.value = '0';
                    if (qtyInput) calculateRow(qtyInput);
