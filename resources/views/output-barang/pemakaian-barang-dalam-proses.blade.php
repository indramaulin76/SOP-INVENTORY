...
@section('title', 'Pemakaian Barang Dalam Proses')

@section('content')
<div class="card">
    <div class="card-header">
        <h2>Form Input Pemakaian Barang Dalam Proses</h2>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form action="{{ route('output-barang.store-pemakaian-proses') }}" method="POST" id="mainForm">
            @csrf
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Handle form submission to ensure calculations are correct
