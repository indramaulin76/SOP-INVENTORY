...
@section('title', 'Penjualan Barang Jadi')

@section('content')
<div class="card">
    <div class="card-header">
        <h2>Form Input Penjualan Barang Jadi</h2>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form action="{{ route('output-barang.store-penjualan') }}" method="POST" id="mainForm">
            @csrf
            ...
            <div class="form-row">
                <div class="form-group" style="position: relative;">
                    ...
                    <input type="text" id="nama_customer" name="nama_customer" class="input autocomplete-input" value="{{ old('nama_customer') }}" placeholder="Nama Customer" autocomplete="off" required>
            ...
            <h3 class="mb-20 mt-30">Daftar Barang Jadi</h3>
            ...
            <button type="button" class="btn btn-primary mt-20" id="btnAddRow" onclick="addRow()">+ Tambah Barang Jadi</button>
